...
export default class View {
  ...
  update(data){
    ...
    const newDom = document.createRange().createContextualFragment(newMarkup); // this method will convert a string to a new DOM object
    ...
    newElements.forEach((newEl, i) => {
      ...
      if(!newEl.isEqualNode(curEl) && newEl.firstChild?.nodeValue.trim() !== ''){ 
        // console.log(curEl.firstChild?.nodeValue.trim(), newEl.firstChild.nodeValue.trim());
